...
def get_combined_records():
    ...
    bucket = storage_client.get_bucket('guardian_data_storage')
    ...
    for blob in blobs:
        ...
        blob.download_to_filename(f"/home/airflow/gcs/data/capstone2/{filename}")
        print(f"Concatenate {filename} together into a single Dataframe")
        file_df = pd.read_csv(f"/home/airflow/gcs/data/capstone2/{filename}")
    ...
    if len(combined_df) > 0:
        ...
        combined_df.to_csv(f'/home/airflow/gcs/data/capstone2/{combined_filename}', index=False)
...
def clean_and_process_records():
    df = pd.read_csv('/home/airflow/gcs/data/capstone2/combined_files.csv')
    print("Renaming columns")
    df.to_csv('/home/airflow/gcs/data/capstone2/cleaned_files.csv', index=False)

def upload_to_bigquery():
    client = bigquery.Client()

    table_id = "egen-project-1.dataset_capstone2.table_cap2"
    ...
    uri= f'gs://us-central1-composer-egen-1e9489c0-bucket/data/capstone2/cleaned_files.csv'
